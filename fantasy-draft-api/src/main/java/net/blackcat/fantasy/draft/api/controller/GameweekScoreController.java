...
public class GameweekScoreController {
	...
	/**
	 * Calculate the scores for the current gameweek.
	 */
	...
	@ResponseStatus(value = HttpStatus.OK)
	public void calculateHistoricalGameweekScores(@PathVariable final int gameweek) {
		gameweekPointsController.calculateHistoricalGameweekPoints(gameweek);
	}
}
